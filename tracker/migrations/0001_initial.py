# Generated by Django 3.0.5 on 2020-07-19 07:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_date', models.DateField(default=datetime.date(2020, 7, 20))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='child', to='tracker.Space')),
            ],
        ),
        migrations.AddField(
            model_name='chore',
